Hello, This is a Weather application built using React JS, Tailwind CSS and OpenWeatherMap free api. You can get free api key here by signing in(https://openweathermap.org/current#name).
